...
En esta actividad, he implementado un sistema de física de sonido 3D en Unity con el objetivo de analizar cómo el movimiento y la configuración de los parámetros de audio afectan a la percepción del usuario. Para ello, he configurado un objeto con una fuente de sonido y un script de movimiento de alta velocidad activado por la tecla "M", vinculando además una cámara de Cinemachine para mantener el seguimiento visual. El propósito principal ha sido simular y estudiar el efecto Doppler, observando cómo la compresión de las ondas sonoras altera la frecuencia del audio en función de la velocidad relativa entre la fuente y el oyente.
